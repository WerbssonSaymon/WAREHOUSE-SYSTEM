...
export default function formSupplier({
  ...
  return (
    <div className="mt-4">
     ...
     <FormField label="Ativo" type="checkbox" checked={currentSupplier ? updatedAtivo : ativo} onChange={(e) => currentSupplier ? setUpdatedAtivo(e.target.cheked) : setAtivo(e.target.cheked)} />
      ...
      <FormField label="Liberado" type="checkbox" checked={currentSupplier ? updatedLiberado : liberado} onChange={(e) => currentSupplier ? setUpdatedLiberado(e.target.cheked) : setLiberado(e.target.cheked)} />
      </div>
     <div className="grid grid-cols-1 sm:grid-cols-4 gap-x-8 gap-y-6">
